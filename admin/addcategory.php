        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Add Exercise Category</h1>

                    <form action="inscat.php" method="post">
                        <div class="form-group col-md-6">
                            <label for="cname">Exercise Category Name</label>
                            <input type="text" name="cname" id="cname" class="form-control" required>
                        </div>
                        <button type="submit" name="save" class="btn btn-success">Add Category</button>
                    </form>
